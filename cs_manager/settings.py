"""
Django settings for cs_manager project.
...
SECRET_KEY = 'ph4k5yh8%jurj!x$=bld!5_m8fggi6^^iw$#%l31noe7pv5oub'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'eboard', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'eboard', 'static'),
]

# Variable from Dockerfile
if os.environ.get('FRONTEND_INSTALL_DIR'):
    STATICFILES_DIRS += [
        os.path.join(os.environ['FRONTEND_INSTALL_DIR'], 'node_modules'),
    ]
